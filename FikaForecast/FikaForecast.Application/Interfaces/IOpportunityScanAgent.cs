...
/// <summary>
/// Executes the Opportunity Scan Agent via chat completions.
/// Receives pre-built input text (formatted substitution chain data)
/// and does not search the web.
/// </summary>
public interface IOpportunityScanAgent
{
    /// <summary>
    /// Runs the agent with the given model, prompt, and formatted substitution chain input.
    /// </summary>
    /// <param name="model">Azure AI Foundry model deployment to use.</param>
    /// <param name="prompt">System prompt for the agent.</param>
    /// <param name="inputText">Formatted substitution chain text built from DB data.</param>
